...
var testArray = [2, 3, 4]; //eslint-disable-line
  ...
  const b = testArray[1];
  const c = testArray[2];
function sumArray(anyArray) { //eslint-disable-line

     return [sum(sum(a,b)[0], c)[0], testArray + ' was passed in as an array of numbers, and ' + sum(sum(a,b)[0], c)[0] + ' is their sum.']
...
function multiplyArray(multArr) { //eslint-disable-line 
  ...
  return [multiply(multiply(a,b)[0], c)[0], 'The numbers ' + testArray + ' have a product of ' + multiply(multiply(a,b)[0], c)[0] + '.' ]
